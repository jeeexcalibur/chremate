  ...
  <div class="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
    ...
    <div class="w-full max-w-md relative z-10 animate-scale-in">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-muted-foreground">Your smart money companion</p>
      </div>

      <!-- Card -->
      <div class="bg-card rounded-2xl border border-border p-8 shadow-xl shine">
        <h2 class="text-xl font-semibold mb-6 text-card-foreground">Welcome back</h2>
        ...
        <form @submit.prevent="handleEmailLogin" class="space-y-4">
          <div>
            <label for="login-email" class="block text-sm font-medium text-card-foreground mb-1.5">Email</label>
            <input
              id="login-email"
              v-model="email"
              type="email"
          ...
          <div>
            <label for="login-password" class="block text-sm font-medium text-card-foreground mb-1.5">Password</label>
            <div class="relative">
              <input
                id="login-password"
                v-model="password"
        ...
        <div class="flex items-center my-6">
          ...
          <span class="px-4 text-sm text-muted-foreground">or continue with</span>
          <div class="flex-1 border-t border-border"></div>
        </div>
